...
export async function createTurnAgentRunContext<ContextValue>(
  ...
  const agent = inferenceProvider === "cursor"
    ...
    : createProviderPromptSession(inferenceProvider, "chat") as unknown as TurnAgentPromptSession;
  ...
  ) : createProviderPromptSession(inferenceProvider, "compact") as unknown as SummarizationPromptSession;
